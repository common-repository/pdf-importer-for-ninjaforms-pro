...
== Description ==
https://www.youtube.com/watch?v=25JrIEJqv2k&t=1s

Do you have a pdf or word document and just want to fill it using one of your forms? This is the plugin for you.

With this plugin you can bind any PDF (including word documents saved as pdf) to a form, the plugin will fill the pdf using the form information and will attach the result to the Ninja Forms emails.
...
- **Automatically attached to the Ninja Forms emails:** You just need to import a pdf, bind it to a form and the plugin will do the rest.


== Screenshots ==
1. A very easy to use visual designer
2.- Just select a field from your pdf
3.- And then link it to a form
